...
public class SaveReviewers implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		List<FormSubmissionDto> form = (List<FormSubmissionDto>) execution.getProcessInstance().getVariable("reviewers");
		...
		for (FormSubmissionDto formField : form) {
			...
			magaz.addReviewer(userRepository.findByUsername(formField.getFieldValue()));
		}
